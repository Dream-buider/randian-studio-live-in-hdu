  ...
  <main class="welcome-page" data-theme="randian-dawn">
    ...
    <footer class="welcome-footer">
      ...
      <div class="welcome-footer-actions">
        ...
        <RouterLink :to="{ name: 'agent' }" class="welcome-agent-entry" data-action="enter-agent">
          <span>体验成长任务 Agent</span>
        </RouterLink>
      </div>
    </footer>
  </main>
...
.welcome-footer .welcome-agent-entry {
  min-height: 44px;
  padding: 11px 16px;
  border-color: rgb(255 232 201 / 38%);
  background: rgb(72 43 31 / 42%);
  box-shadow:
    0 10px 24px rgb(72 34 25 / 23%),
    inset 0 1px rgb(255 246 229 / 18%);
  font-size: 0.88rem;
  font-weight: 720;
}

.welcome-footer a:focus-visible {
  outline: 3px solid #fff9ec;
  outline-offset: 3px;
}
